...
- Voltage screw terminals use the Phoenix 1x02 P3.50 mm STEP as a 4Ucon substitute with model offset `(0, -0.6, 0)`; keep pads at the continuous 3.5 mm row positions `J2=155`, `J3=162`, `J4=169`.
