...
for index in range(6):
    REFERENCE_PLACEMENTS[f"R{10 + index}"] = (156.300, 116.000 + index * 2.200, 0)
    REFERENCE_PLACEMENTS[f"C{20 + index}"] = (167.400, 116.000 + index * 2.200, 0)
    REFERENCE_PLACEMENTS[f"R{21 + index}"] = (144.200, 114.950 + index * 2.200, 0)
    REFERENCE_PLACEMENTS[f"R{27 + index}"] = (151.100, 117.050 + index * 2.200, 0)
